...
ACA_PY_URL = os.getenv("ACA_PY_URL", "https://cloud-aries-admin.devlab.biz.id")
...
ACA_PY_TOKEN = os.getenv("ACA_PY_TOKEN", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ3YWxsZXRfaWQiOiJjY2RkNmJmNC1jYzliLTQ0MTYtYmI5Yy1iMWNjNTg4YzJjODAiLCJpYXQiOjE3ODg3NTEyNTd9.PlIu0ZdMxW1UspBqTQvDcg77z7BqzHJ1DpzSUWi_raI")
WALT_ID_TOKEN = os.getenv("WALT_ID_TOKEN", "Bearer eyJhbGciOiJIUzI1NiJ9..ZeZA3DVAMrqCvoHabwT2Mj4ljekbLNdNzfljDA6wzho")

WALT_WALLET_API_BASE = "https://wallet-api.devlab.biz.id"
WALLET_ID = "6923c4db-2880-4a6f-8f15-dac3d4f0a3a3"
